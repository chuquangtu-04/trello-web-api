...
export const OBJECT_ID_RULE_MESSAGE_MOVING_CARD = (message) => {
  return `Your string fails to match the Object Id pattern key: ${message}`
}
...
export const EMAIL_RULE_MESSAGE = 'Email is invalid. (name@gmail.com)'
